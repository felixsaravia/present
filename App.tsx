...
const App: React.FC = () => {
  const DONATION_URL = "https://ko-fi.com/nextlevelsv"; // Reemplaza 'placeholder' con tu usuario real
            ...
            <header className="bg-white shadow-md sticky top-0 z-50">
              <div className="container mx-auto px-4 py-3 flex justify-between items-center">
                ...
                <a
                  ...
                  className="bg-pink-500 hover:bg-pink-600 text-white font-semibold py-2 px-3 rounded-lg text-sm flex items-center space-x-1.5 transition-colors"
                  aria-label="Apoyar el desarrollo de la aplicación"
                >
                  <HeartIcon />
                  <span>Apoyar</span>
                </a>
